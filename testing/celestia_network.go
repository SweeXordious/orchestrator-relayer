...
// The EVM key that was used to create this network single validator can
// be gotten using: `celestiatestnode.NodeEVMPrivateKey`
...
func NewCelestiaNetwork(t *testing.T, blockTime time.Duration) *CelestiaNetwork {
	// instead of using static port 26657, try assigning the port number dynamically to be able to run the
	// tests in parallel
